...
__help__ = """
**For text assistant**
 - /Eliana <question>: Ask Eliana any question and it will give accurate reply. For eg: `/Eliana where is Taj Mahal`, `/Eliana what is the age of Virat Kohli` etc..
**For voice assistant**
 - /Eliana: Reply to a voice query and get the results in voice output (ENGLISH ONLY)
