#Test
from Eliana import tbot, OWNER_ID, DEV_USERS, SUDO_USERS
...
from Eliana import TEMP_DOWNLOAD_DIRECTORY as path
from Eliana import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
from Eliana.func import progress
...
async def Prof(event):
    ...
    the_plugin_file = "./Eliana/modules/{}.py".format(input_str)
