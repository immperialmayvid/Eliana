...
from Eliana import CMD_LIST, LOAD_PLUG, tbot
import glob
import sys
from Eliana import ubot
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Eliana/modules/{shortname}.py")
        name = "Eliana.modules.{}".format(shortname)
        ...
        mod.Elianabot = Elianabot
        mod.tbot = tbot
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["Eliana.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Eliana/modules/*.py"
