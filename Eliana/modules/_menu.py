...
from Eliana import CMD_HELP, BOT_VERSION
        ...
        await event.edit(
            ...
            buttons=[
                ...
                [
                    ...
                    Button.url("Webiste 🌐", "missElianarobot.unaux.com"),
                    Button.url("Donate 💲", "https://ko-fi.com/missElianarobot"),
                ],
